package com.myntra.rediesconfig;
...
public class RediesConfig {
	...
	public RedisConnectionFactory redisConnectionFactory() {
		...
		RedisStandaloneConfiguration redisConfig =
			    new RedisStandaloneConfiguration("resolved-spaniel-40311.upstash.io", 6379);

		redisConfig.setUsername("default");
		redisConfig.setPassword("AZ13AAIncDI5ODFhMzIwNDlhZjI0NDAwYmJlNTVlNmYyMGRiZWU5MXAyNDAzMTE");
